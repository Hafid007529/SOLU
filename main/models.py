...
class Proveedor(models.Model):
    ...
    razon_social = models.CharField(max_length=20) #es la nominación porque la cual se conoce legalmente a una empresa
...
class Producto(models.Model):
    ...
    def get_precio_final(self): #por un tema de organización, necesitamos llamar este precio
...
#charfield, alguien puede ponerlo
# Create your models here.
#django le pone id a todo.

from django.contrib.auth.models import User  #para hacer el modelo user
...
class ProductoImage(models.Model): #damos la livertad para que modifique la imagen de sus productos
